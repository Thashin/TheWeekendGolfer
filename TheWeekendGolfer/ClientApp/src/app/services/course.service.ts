...
export class CourseService {
  ...
  getCourses() {
    return this._http.get<Course[]>(
      this.theWeekendGolferUrl + "api/Course/Index"
    );
  }

  getCourseNames() {
    return this._http.get<string[]>(
      this.theWeekendGolferUrl + "api/Course/GetCourseNames"
    );
  }
  ...
  getCourseTees(courseName: string) {
    return this._http.get<string[]>(
      this.theWeekendGolferUrl +
        "api/Course/GetCourseDetails?CourseName=" +
        courseName
    );
  }
  ...
  getCourseById(id: string) {
    return this._http.get<Course>(
      this.theWeekendGolferUrl + "api/Course/Details/" + id
    );
  }
}
