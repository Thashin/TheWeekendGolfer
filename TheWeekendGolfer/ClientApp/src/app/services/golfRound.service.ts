...
export class GolfRoundService {
  ...
  getGolfRounds() {
    return this._http.get<GolfRoundView[]>(
      this.theWeekendGolferUrl + "api/GolfRound/Index"
    );
  }

  getGolfRoundById(id: string) {
    return this._http.get<GolfRound>(
      this.theWeekendGolferUrl + "api/GolfRound/Details/" + id
    );
  }
  ...
  createGolfRound(golfRound: AddGolfRound) {
    ...
    return this._http.post(
      this.theWeekendGolferUrl + "api/GolfRound/Create",
      body,
      options
    );
  }
  ...
  updateGolfRound(golfRound) {
    return this._http.put(
      this.theWeekendGolferUrl + "api/GolfRound/Edit",
      golfRound
    );
  }
  ...
  deleteGolfRound(id) {
    return this._http.delete(
      this.theWeekendGolferUrl + "api/GolfRound/Delete/" + id
    );
  }
